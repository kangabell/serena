...
add_action('init', 'serena_head_cleanup');
...
function serena_head_cleanup() {
  ...
  add_filter( 'style_loader_src', 'serena_remove_wp_ver_css_js', 9999 );
  // remove Wp version from scripts
  add_filter( 'script_loader_src', 'serena_remove_wp_ver_css_js', 9999 );

} /* end serena head cleanup */
...
function serena_scripts_and_styles() {
  if (!is_admin()) {
    ...
    wp_register_script( 'serena-modernizr', get_stylesheet_directory_uri() . '/library/js/libs/modernizr.custom.min.js', array(), '2.5.3', false );
    ...
    wp_register_script( 'serena-js', get_stylesheet_directory_uri() . '/library/js/scripts.js', array( 'jquery' ), '', true );
